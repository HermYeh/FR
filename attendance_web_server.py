...
Remote web interface for attendance management
'''
...
def api_employees():
    """API endpoint for employees list"""
    db = get_db()
    employees = db.get_employees()
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">Check system status</p>
                <a href="/status" class="btn btn-warning">Status</a>
            </div>
        </div>
    </div>
</div>
